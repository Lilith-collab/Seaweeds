...
In the following, I describe my workflow step-by-step. 
...
Here, I generate some plots to get an overview of the MPA data, I reduce it to
show only the relevant column (MPA names) and create an additional plot using tidyverse, which also creates a legend. In this last plot the map is squashed, 
...
Figure 1: Plots of the properties of each attribute in the attribute table.
...
I create my first plot that includes the 3 species occurrences within the MPAs.
...
Figure 7: Observations of three seaweed species within existing MPAs. 
...
Figure 12: Map of seaweed species occurrences within existing South African
Marine Protected Areas, records from Betty's Bay and Robben Island MPAs are 
labelled. 

Looking at the distribution of the three agar-producing seaweed species, it is 
clear that they all occur within established Marine Protected Areas in the 
study region. The creation of new MPAs or expansion of existing ones does not 
